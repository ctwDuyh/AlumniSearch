...
public class AcademyWebsitePageProcessor implements PageProcessor {
    private static String academyLinkRe = "\\S*edu.cn/*";
    private static Pattern academyLinkPattern = Pattern.compile(academyLinkRe);
    ...
    private static String tableName = "academy";
    ...
    public void process(Page page) {
        ...
        Selectable academyPage;

        List<String> academyPages = new ArrayList<String>();
...
//            // 对应网址，进行匹配工作
//            academyPage = page.getHtml().xpath(collegeLinkXpath);
//            academyPages = academyPage.all();
//            page.addTargetRequests(academyPages);
//        }
